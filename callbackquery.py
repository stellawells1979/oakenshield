...
log = LogManager('CallbackQuery', logging.WARNING, logging.INFO)
...
class CallbackQuery:
    ...
    def __init__(self, bot, data):
        ...
        :var self.myaccount 机器的信息集，包含了机器人的全部信息，可能会由其它方法初始化
        :var self.bot 机器人的别名，从 self.myaccount 属性提取
    ...
    def parse_verify(self):
        ...
        if self.user_id != verify_user_id:
            ...
            self.send_data.append([
                ...
                {'delay': wholetime.unix() + 5}     # 此消息延迟5秒发送
            ])
